...
<div class="about-section">
  <h1>About Us Page</h1>
  <p>Welcome to MovieTick, your ultimate destination for hassle-free movie ticketing! We are dedicated to providing you with a seamless and convenient experience in the world of cinema. 
...
<div class="row">
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        <h2>Akshaya Raveendran</h2>
        <p class="title">UI/UX designer and co-founder</p>
        <p>Front-end developer and styling assist</p>
        <p>akshaya.raveendran@gamil.com</p>
  ...
  <div class="column">
    <div class="card">
      <img src="images/ansh.jpeg" alt="Mike" style="width:100%;height:500px">
      <div class="container">
        <h2>Ansh Bomb</h2>
        <p class="title">Back-end developer and Co-founder</p>
        <p>Back-end developer</p>
        <p>anshbomb@gmail.com</p>
        <p><button class="button">Contact</button></p>
      </div>
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <img src="images/boobash.jpeg" alt="John" style="width:100%;height:500px">
      <div class="container">
        <h2>Boobash</h2>
        <p class="title">Web-page Designer</p>
        <p>Designing major</p>
        <p>boobash@gmail.com</p>
        <p><button class="button">Contact</button></p>
      </div>
    </div>
  </div>
