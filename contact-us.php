...
<body>
    ...
    <div class="contact-us-container">
        <div class="contact-us-section contact-us-section1">
            <h1>Contact</h1>
            <p color:"#05004e">Feel Free to Contact Us </p>
        ...
        <div class="contact-us-section contact-us-section2">
            <h1>Address & Info</h1>
            <h3>Phone Numbers</h3>
            <p><a href="tel:01011391148">+91 9952909441</a><br>
                <a href="tel:01011391148">+91 7895625637</a></p>
            <h3>Address</h3>
            <p>The office, Scranton, New york</p>
            <h3>E-mail</h3>
            <p><a href="mailto:cinemareservation@bue.edu.eg">movietick@bue.edu.eg</a></p>
        </div>
    </div>
